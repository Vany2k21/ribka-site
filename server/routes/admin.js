...
router.post('/settings', upload.single('heroImage'), (req, res) => {
...
router.post('/categories', categoryImageUpload, (req, res) => {
...
router.post('/categories/:id', categoryImageUpload, (req, res) => {
  const patch = { ...req.body };
  if (req.files && req.files.image) patch.image = '/uploads/' + req.files.image[0].filename;
  if (req.files && req.files.iconImage) patch.iconImage = '/uploads/' + req.files.iconImage[0].filename;
...
router.post('/products', productImageUpload, (req, res) => {
...
router.post('/products/:id', productImageUpload, (req, res) => {
  const patch = { ...req.body };
